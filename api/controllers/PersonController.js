...
module.exports = {
    ...
    index: async function (req, res) {
        ...
        var models = await Person.find(); //empty means everything 
    ...
    view: async function (req, res) {
        ...
        var message = Person.getInvalidIdMsg(req.params); //get the correct id from user

        if (message) return res.badRequest(message);

        var model = await Person.findOne(req.params.id); // capture the values
